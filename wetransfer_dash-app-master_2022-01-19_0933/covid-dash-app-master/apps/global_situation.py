...
df = pd.read_csv('/Users/LizzyDRB/Documents/MSc Data Science/DSP/covid-dash-app-master/COVID-19-geographic-disbtribution-worldwide.csv', index_col = 0)
...
layout = html.Div([
    dbc.Container([
        dbc.Row([
            dbc.Col(html.H1(children='Results'), className="mb-2")
        ]),
        dbc.Row([
            dbc.Col(html.H6(children='Description'), className="mb-4")
        ]),
